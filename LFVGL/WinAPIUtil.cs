...
namespace LFVGL
{
	public class WinAPIUtil
	{
		...
		public static extern bool GetCursorPos([In, Out] WinAPIUtil.POINT pt);
		...
		public static MouseButtons GetMouseButtons
		{
			get
			{
				...
				if (WinAPIUtil.GetKeyState(1) < 0)
				{
					none |= MouseButtons.Left;
				}
				if (WinAPIUtil.GetKeyState(2) < 0)
				{
					none |= MouseButtons.Right;
				}
				if (WinAPIUtil.GetKeyState(4) < 0)
				{
					none |= MouseButtons.Middle;
				}
				if (WinAPIUtil.GetKeyState(5) < 0)
				{
					none |= MouseButtons.XButton1;
				}
				if (WinAPIUtil.GetKeyState(6) < 0)
				{
		...
		public static Keys ModifierKeys
		{
			...
			{
				Keys none = Keys.None;
				if (WinAPIUtil.GetKeyState(0x10) < 0)
				{
					none |= Keys.Shift;
				}
				if (WinAPIUtil.GetKeyState(0x11) < 0)
				{
					none |= Keys.Control;
				}
				if (WinAPIUtil.GetKeyState(0x12) < 0)
				{
					none |= Keys.Alt;
				}
				return none;
        ...
        public const int SND_SYNC = 0x0;          // TOCANDO com sincronismo
        public const int SND_ASYNC = 0x1;         // TOCANDO sem sincronismo
